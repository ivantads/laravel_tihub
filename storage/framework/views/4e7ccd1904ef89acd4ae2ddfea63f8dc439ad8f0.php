                        ...
                        <div class="col">
                            <div class="card">
								...
								<a class="btn btn-info float-right" href="<?php echo e(route('Cadastros.Clientes')); ?>">Voltar</a>
								  ...
								  <?php endif; ?>	
								  <?php echo Form::open(['route' => ['Cadastros.Clientes.Atualizar',$clienteDados->id], 'role' => 'form', 'enctype' => 'multipart/form-data']); ?>
...
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tihub/laravel/resources/views/cadastros/clientes/editar.blade.php ENDPATH**/ ?>