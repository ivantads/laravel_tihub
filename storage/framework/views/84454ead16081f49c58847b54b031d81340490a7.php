                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="table-responsive m-t-35">
								    <?php echo $__env->make('calendario/modal_events', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
									<div id="calendar" data-route-load-events="<?php echo e(route('routeLoadEvents')); ?>"></div>
                                </div>
                            </div>
                        </div>
					</div>
...
<link type="text/css" rel="stylesheet" href="<?php echo e(asset('assets/vendors/chosen/chosen.min.css')); ?>"/>
...
<script type="text/javascript" src="<?php echo e(asset('assets/vendors/chosen/chosen.jquery.min.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/vendors/jquery-mask-plugin/jquery.mask.min.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('assets/js/pages/calendar.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('assets/js/forms.js')); ?>"></script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts/default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tihub/laravel/resources/views/calendario/index.blade.php ENDPATH**/ ?>