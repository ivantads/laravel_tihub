...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('suporte/assets/img/tihub.ico')); ?>"/>
	<link rel="apple-touch-icon" href="<?php echo e(asset('suporte/assets/img/tihub.png')); ?>"/>
    ...
    <!-- Stylesheets -->
    <link type="text/css" rel="stylesheet" href="<?php echo e(asset('suporte/assets/css/bootstrap.min.css')); ?>"/>
	<link type="text/css" rel="stylesheet" href="<?php echo e(asset('suporte/assets/css/font-awesome.min.css')); ?>"/>
    <!-- end of styles-->
...
<body>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <form class="footer-newsletter-form" id="formNewsletter" enctype="multipart/form-data">
                                <h4>Novidades</h4>
                                <?php echo Form::email('EmailN','',['class' => 'form-control', 'id' => 'EmailN','placeholder' => 'Seu email...','required' => 'required','onkeyup' => 'lower(this)']); ?>

								<span class="errors"><?php echo e($errors->first('EmailN')); ?></span>
  ...
  <!-- JS Files -->
  <script type="text/javascript" src="<?php echo e(asset('suporte/assets/js/jquery.min.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('suporte/assets/js/popper.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(asset('suporte/assets/js/bootstrap.min.js')); ?>"></script>
  <?php echo $__env->yieldContent('js'); ?>
</body>

</html>
<?php /**PATH /home/tihub/laravel/resources/views/layouts/site.blade.php ENDPATH**/ ?>