        ...
        <div class="col-12">
            <div class="row">
				...
				<div class="col-lg-5 col-md-8 col-sm-12 mx-auto forgotpwd_margin">
					...
					<form method="POST" action="{{ route('password.email') }}" id="login_validator1" class="form-group  login_validator">
					 @csrf
                        <div class="bg-white login_content login_border_radius">
                            <div class="form-group">
                                <label for="email_modal">{{ __('E-Mail Address') }}</label>
                            ...
                            <span class="input-group-addon addon_email"><i
                                    ...
                                    <input id="email" type="email" class="form-control  email_forgot form-control-md @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="E-mail">										   
                                </div>
                            </div>
                            <div class="form-group form-actions">
                                <button type="submit" class="btn btn-primary submit_email login_button">{{ __('Send Password Reset Link') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
